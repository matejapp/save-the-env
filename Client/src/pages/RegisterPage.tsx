    ...
    <div className="min-h-screen bg-[#131313] flex items-center justify-center px-4">
      <div className="w-full max-w-md">
        <div className="mb-8 text-center">
          ...
          <h1 className="text-2xl font-semibold text-[#e5e2e1] mb-2">Create your account</h1>
          <p className="text-[#c4c9ac] text-sm">Start securing your environment variables</p>
        </div>
        ...
        <div className="bg-[#1c1b1b] border border-[#2a2a2a] rounded-xl p-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              <label className="block text-sm text-[#c4c9ac] mb-2">Confirm password</label>
              <input
                type="password"
                value={confirm}
          ...
          <div className="mt-6 pt-6 border-t border-[#2a2a2a] text-center">
            <p className="text-[#8e9379] text-sm">
              ...
              <Link to="/login" className="text-[#c3f400] hover:text-[#abd600] transition-colors">
                Sign in
              </Link>
            </p>
          </div>
